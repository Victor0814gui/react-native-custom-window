...
namespace Window {
    ...
    struct FullscreenModule final {  
          ...
          void Window::Initialize(const winrt::Microsoft::ReactNative::ReactContext& reactContext) noexcept
          {
          ...
          void Window::ExtendView_Click() noexcept
          {
        ...
        void Window::AddBackButton() noexcept
        {
            context.UIDispatcher().Post([] {
        ...
        void Window::RemoveBackButton() noexcept
        {
            context.UIDispatcher().Post([] {
            auto currentView = SystemNavigationManager::GetForCurrentView();
        ...
        REACT_METHOD(RemoveBackButton, L"disabledBackButton");
          void Window::DisabledBackButton() noexcept
          {
              context.UIDispatcher().Post([] {
                auto currentView = SystemNavigationManager::GetForCurrentView();
          ...
          void Window::RestoreExtendView_Click() noexcept
          {
              context.UIDispatcher().Post([] {
          ...
          void Window::setSize(float  w, float  h) noexcept
          {
          ...
          std::optional<Windows::UI::Color> Window::ParseColor(std::string color)
          {
